...
Page({
  data: {
    ...
    _time: [ //课程时间与指针位置的映射，{begin:课程开始,end:结束时间,top:指针距开始top格数}
      //上午
      { begin: '0:00', end: '8:09', beginTop: -4, endTop: -4 },
      { begin: '8:10', end: '9:50', beginTop: 0, endTop: 200 },
      { begin: '9:51', end: '10:09', beginTop: 204, endTop: 204 },
      { begin: '10:10', end: '11:50', beginTop: 208, endTop: 408 },
      //下午
      { begin: '11:51', end: '13:59', beginTop: 414, endTop: 414 },
      { begin: '14:00', end: '15:40', beginTop: 420, endTop: 620 },
      { begin: '15:41', end: '15:59', beginTop: 624, endTop: 624 },
      { begin: '16:00', end: '17:40', beginTop: 628, endTop: 828 },
      //晚上
      { begin: '17:41', end: '18:09', beginTop: 834, endTop: 834 },
      { begin: '18:10', end: '19:50', beginTop: 840, endTop: 1040 },
      { begin: '19:51', end: '19:59', beginTop: 1044, endTop: 1044 },
      { begin: '20:00', end: '21:40', beginTop: 1048, endTop: 1248 },
      { begin: '21:41', end: '23:59', beginTop: 1254, endTop: 1254 },
    ],
    timelineTop: 0,
    scroll: {
      left: 0
  ...
  loginHandler: function(options){
    ...
    var id = options.id || app._user.we.ykth;
    if(!id){
      _this.setData({
        remind: '未绑定'
      });
